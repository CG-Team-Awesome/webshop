...
<div class="show_page_outer-wrapper">
    <div class="show_page_inner-wrapper">
        ...
        <div class="sp_slide sp_lefthalf d-flex justify-content-center align-items-center">
            ...
            {{-- PRODUCT PICTURE DIV --}}
            {{-- PRODUCT PICTURE DIV --}}
            <<<<<<< Updated upstream <div class="sp_left_div1 d-flex justify-content-center align-items-center row"
                id="gallery" data-toggle="modal" data-target="#exampleModal">
        ...
        =======
        <div class="sp_left_div1 d-flex justify-content-center align-items-center row" id="gallery" data-toggle="modal"
