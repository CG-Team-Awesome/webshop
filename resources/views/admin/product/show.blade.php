...
<div class="show_page_outer-wrapper">
    <div class="show_page_inner-wrapper">
        ...
        <div class="sp_slide sp_lefthalf d-flex justify-content-center align-items-center">
            ...
            <a href="{{ Route('admin.product.index') }}"><button class="btn btn-mau shadow-mau btn-showpage1">Back</button></a>
            {{-- PRODUCT PICTURE DIV --}}
            {{-- PRODUCT PICTURE DIV --}}
            <div class="sp_left_div1 d-flex justify-content-center align-items-center row" id="gallery"
                ...
                <div class="sp_left_div1_container d-flex justify-content-center align-items-center">
                    <img class="sp_left_div1_img" src="{{ $image->url }}" alt="{{ $image->alt }}"
            ...
            <div class="sp_left_div2 d-flex justify-content-center align-items-center row">
                ...
                <div class="sp_left_div2_inner d-flex justify-content-center align-items-center shadow-mau row">
                    ...
                    <div class="col-6">
                        ...
                        <h3 class="text-center text-white text-font"> {{ $product->strap_color }} </h3>
                    </div>
                    <div class="col-6">
                        <h3 class="text-center text-white text-font">Size</h3>
                        <h3 class="text-center text-white text-font"> {{ $product->size }} </h3>
                    </div>
                    <div class="col-6">
                        <h3 class="text-center text-white text-font">Stock</h3>
                        <h3 class="text-center text-white text-font"> @switch ($product->in_stock) @case(0) Not
                            available @break @case(1) Only one left @break @default Available @endswitch </h3>
                    </div>
                    <div class="col-6">
                        <h3 class="text-center text-white text-font">Product Price</h3>
                        <h3 class="text-center text-white text-font"> &euro;{{ $product->price }} </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="sp_left_div3 d-flex justify-content-center align-items-center row">
                ...
                @foreach ($product->latestreviews as $review)
                <div class="div3_review_div col-12 shadow-mau">
                    @for ($i=0;$i<$review->rating;$i++)
                        *
                        @endfor
                        <hr />
                        <h3 class="text-white text-center text-font mt-4">{{ $review->review }}</h3>
                </div>
                @endforeach
                <a href="{{ Route('admin.product.index') }}"><button class="btn btn-mau shadow-mau btn-showpage2">Back</button></a>
            </div>
        </div>
