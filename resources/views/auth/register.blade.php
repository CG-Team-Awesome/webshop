<div class="container-fluid register-div">
    <x-guest-layout>
        <x-auth-card>
            ...
            <div class="card-body register-card shadow-mau">
                <!-- Validation Errors -->
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-0">
                        <div class="d-flex justify-content-end align-items-baseline">
                            <a class="text-white mr-3 text-decoration-none" href="{{ route('login') }}">
                                {{ __('Ik heb al een account.') }}
                            </a>

                            <div>
                                <a href="{{ __('Registreer') }}"><button class="btn btn-mau shadow-mau mt-3">Register</button></a>
                            </div>
                        </div>
                    </div>
                </form>
